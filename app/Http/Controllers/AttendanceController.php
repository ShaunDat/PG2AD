...
class AttendanceController extends Controller
{
    ...
    function __construct()
    {
        ...
        $this->middleware(['role:trainer', 'permission:attendance-edit'], ['only' => ['edit','update']]);
        $this->middleware(['role:trainer|admin', 'permission:attendance-delete'], ['only' => ['destroy']]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $request['trainer_id'] = Auth()->user()->id;
