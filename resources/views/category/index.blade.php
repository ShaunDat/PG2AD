    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2">
            ...
            <div class="ibox-tools m-t-xl">
                <a href="{{ route('category.create') }}" class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><i class="fa fa-plus"></i> <strong>Create</strong></a>
            </div>
            @endunlessrole
        </div>
    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                @foreach ($category as $item)
                                    ...
                                    <tr>
                                        ...
                                        @unlessrole('trainer')
                                        <td>
                                            <a title="Edit" href="{{ route('category.edit', $item->id) }}" class="cus_mini_icon color-success"> <i class="fa fa-pencil-square-o"></i></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h3>You are going to delete ' {{ $item->title }} ' ?</h3>
                                        ...
                                        <form id="topic-delete-form{{ $item->id }}" method="POST" action="{{ route('category.destroy', $item->id) }}" style="display: none" >
                                            {{method_field('DELETE')}}
                                            @csrf()
                                        </form>
