    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <select class="form-control" name="trainee_id" required>

                    <option value="">--Select--</option>
                    <option v-for="trainee in trainees" :selected="trainee.user.id == attendance_user_id ? true : false" :value="trainee.user.id">
                        @{{ trainee.user.name +' - '+ trainee.roll_number }}
                    </option>
